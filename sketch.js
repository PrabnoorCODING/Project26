...
function setup() {
  ...
  playerBase = new PlayerBase(300, random(450, height - 300),450, 150);
  player = new Player(285, playerBase.body.position.y - 153, 50,450);
  ...
  computerArcher = new ComputerArcher(
    width - 340,
    computerBase.body.position.y -450,
    120,
    120
  );
